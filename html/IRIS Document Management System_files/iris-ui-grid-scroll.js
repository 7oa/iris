(function () {
    ...
    angular.module('ui.grid').decorator('uiGridRenderContainerDirective', ['$delegate', '$timeout', '$document', 'uiGridConstants', 'gridUtil', 'ScrollEvent',
        function ($delegate, $timeout, $document, uiGridConstants, gridUtil, ScrollEvent) {
                ...
                return {
                    ...
                    post: function postlink($scope, $elm, $attrs, controllers) {
                        ...
                        gridUtil.on.mousewheel($elm, function (event) {
                            ...
                            var disableScrolling = grid.element.hasClass('iris-grid-autoheight');
